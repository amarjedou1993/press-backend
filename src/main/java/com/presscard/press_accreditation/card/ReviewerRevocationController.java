...
//            Long id, String code, String labelFr, String labelAr, String hintFr,
...
//
//    public ReviewerRevocationController(CardLifecycleService lifecycleService,
...
//                .map(g -> new GroundOption(
//                        g.getId(), g.getCode(), g.getLabelFr(), g.getLabelAr(),
//                        g.getHintFr(), g.isWarrantsImmediateSuspension()))
//                .toList();
//    }
//
//    /** Propose a withdrawal. This does NOT withdraw the card. */
//    @PostMapping
//    public ProposalResponse propose(@Valid @RequestBody ProposeRequest request,
//                                    Principal principal) {
//        RevocationProposal proposal = lifecycleService.propose(
//                request.cardId(), currentUserId(principal),
//                request.groundId(), request.statement());
//        return /* map via the shared mapper — see note 4 */ null;
//    }
//
//    /** Withdraw one's own proposal, before it is decided. */
//    @PostMapping("/{id}/withdraw")
//    public ProposalResponse withdraw(@PathVariable Long id, Principal principal) {
//        lifecycleService.withdrawProposal(id, currentUserId(principal));
//        return /* map */ null;
//    }
//
...
//                .findByProposedByOrderByProposedAtDesc(currentUserId(principal))
//                .stream().map(/* map */ p -> null).toList();
//    }
//
