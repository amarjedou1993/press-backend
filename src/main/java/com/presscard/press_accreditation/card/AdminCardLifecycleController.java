...
//            String fromStatus, String toStatus, String toStatusLabelFr,
//            String reason, String actorName, String proposedByName, String at
//    ) {}
//
...
//
//    public AdminCardLifecycleController(CardLifecycleService lifecycleService,
...
//    public void suspend(@PathVariable Long cardId,
//                        @Valid @RequestBody ReasonRequest request,
//                        Principal principal) {
//        lifecycleService.suspend(cardId, currentUserId(principal), request.reason());
//    }
//
//    @PostMapping("/{cardId}/reinstate")
//    public void reinstate(@PathVariable Long cardId,
//                          @Valid @RequestBody ReasonRequest request,
//                          Principal principal) {
//        lifecycleService.reinstate(cardId, currentUserId(principal), request.reason());
//    }
//
...
//        return lifecycleService.pendingProposals().stream()
//                .map(/* map */ p -> null).toList();
//    }
//
//    @PostMapping("/revocations/{proposalId}/execute")
//    public void execute(@PathVariable Long proposalId,
//                        @RequestBody(required = false) DecisionRequest request,
//                        Principal principal) {
//        lifecycleService.executeRevocation(proposalId, currentUserId(principal),
//                request == null ? null : request.note());
//    }
//
//    @PostMapping("/revocations/{proposalId}/decline")
//    public void decline(@PathVariable Long proposalId,
//                        @Valid @RequestBody ReasonRequest request,
//                        Principal principal) {
//        lifecycleService.declineRevocation(proposalId, currentUserId(principal),
//                request.reason());
//    }
//
//    /* ── a card's whole life ── */
...
//                        h.getReason(),
//                        nameOf(h.getActorId()),
//                        h.getProposedBy() == null ? null : nameOf(h.getProposedBy()),
